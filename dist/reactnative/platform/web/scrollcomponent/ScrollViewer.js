...
var scrollEndEventSimulator = debounce_1.default(function (executable) {
    executable();
}, 1200);
/***
...
var ScrollViewer = /** @class */ (function (_super) {
    ...
    ScrollViewer.prototype.componentWillMount = function () {
        if (this.props.onSizeChanged) {
    ...
    ScrollViewer.prototype.componentWillReceiveProps = function (nextProps) {
        if (this.props.distanceFromWindow !== nextProps.distanceFromWindow) {
            if (this._mainDivRef) {
                this._scrollEventNormalizer = new ScrollEventNormalizer_1.ScrollEventNormalizer(this._mainDivRef, nextProps.distanceFromWindow);
            }
        }
    };
    ...
    ScrollViewer.prototype._setDivRef = function (div) {
        ...
        if (div) {
            this._scrollEventNormalizer = new ScrollEventNormalizer_1.ScrollEventNormalizer(div, this.props.distanceFromWindow);
        }
        else {
