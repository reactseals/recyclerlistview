...
var RecyclerListView = /** @class */ (function(_super) {
  ...
  function RecyclerListView(props) {
    ...
    _this._onViewContainerSizeChange = _this._onViewContainerSizeChange.bind(
      _this
    );
    _this._virtualRenderer = new VirtualRenderer_1.default(
      _this._renderStackWhenReady,
      function(offset) {
  ...
  RecyclerListView.prototype.componentWillMount = function() {
    if (this.props.contextProvider) {
      ...
      if (uniqueKey) {
        ...
        if (this.props.forceNonDeterministicRendering) {
          var cachedLayouts = this.props.contextProvider.get(
            uniqueKey + "_layouts"
          );
    ...
    return React.createElement(
      ...
      __assign(
        ...
        this.props.scrollViewProps,
        {
          ...
          contentHeight: this._initComplete
            ? this._virtualRenderer.getLayoutDimension().height
            : 0,
          contentWidth: this._initComplete
  ...
  RecyclerListView.prototype._checkAndChangeLayouts = function(
    newProps,
    forceFullRender
  ) {
    ...
    if (
      ...
      this._virtualRenderer.setLayoutManager(
        new LayoutManager_1.default(
          newProps.layoutProvider,
          this._layout,
  ...
  RecyclerListView.prototype._onSizeChanged = function(layout) {
    ...
    if (layout.height === 0 || layout.width === 0) {
      throw new CustomError_1.default(
        RecyclerListViewExceptions_1.default.layoutException
      );
    }
  ...
  RecyclerListView.prototype._assertDependencyPresence = function(props) {
    if (!props.dataProvider || !props.layoutProvider) {
      throw new CustomError_1.default(
        RecyclerListViewExceptions_1.default.unresolvedDependenciesException
      );
    }
  };
  RecyclerListView.prototype._assertType = function(type) {
    if (!type && type !== 0) {
      throw new CustomError_1.default(
        RecyclerListViewExceptions_1.default.itemTypeNullException
      );
    }
  };
  ...
  RecyclerListView.prototype._renderRowUsingMeta = function(itemMeta) {
    ...
    if (
      !ts_object_utils_1.ObjectUtil.isNullOrUndefined(dataIndex) &&
      dataIndex < dataSize
    ) {
      var itemRect = this._virtualRenderer.getLayoutManager().getLayouts()[
        dataIndex
      ];
      ...
      return React.createElement(ViewRenderer_1.default, {
        ...
        forceNonDeterministicRendering: this.props
        ...
        itemAnimator: ts_object_utils_1.Default.value(
  ...
  RecyclerListView.prototype._checkExpectedDimensionDiscrepancy = function(
    itemRect,
    type,
    index
  ) {
